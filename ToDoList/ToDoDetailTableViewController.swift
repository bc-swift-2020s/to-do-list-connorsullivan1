...
class ToDoDetailTableViewController: UITableViewController {
        ...
        LocalNotificationManager.isAuthorized { (authorized) in
            DispatchQueue.main.async {
                if !authorized && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User Has Not Allowed Notifications", message: "To recieve alerts for reminders, open the Settings app, Select ToDoList > Notifications > Allow Notifications")
    ...
    func enableDisableSaveButton(text: String) {
        ...
        } else { saveBarButton.isEnabled = false}
    }
